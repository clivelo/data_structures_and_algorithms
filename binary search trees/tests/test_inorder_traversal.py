...
from ..inorder_traversal import inorder_traverse as test_function
...
class UnitTestCase(unittest.TestCase):
    ...
    def test_two_node_not_equal(self):
        t1 = test_function(parse_list([3, 5]))
        t2 = [3, 5]
    ...
    def test_three_node_not_equal(self):
        t1 = test_function(parse_list([7, 5, 3]))
        t2 = [3, 5, 7]
    ...
    def test_imbalance_tree_not_equal(self):
        t1 = test_function(parse_list([7, 5, None, 6, 3]))
        t2 = [3, 5, 6, 7]
